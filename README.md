...
```
# Output screen shots of proteus:
![image](https://github.com/kavyasenthamarai/EXPERIMENT--07-SQUARE-WAVE-GENERATION-AT-THE-OUTPUT-PIN-USING-TIMER/assets/118668727/208ff8ca-6a93-49cc-90ae-fd4425a137ba)
# CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE):
## DUTY CYCLE AND FREQUENCY CALCULATION
FOR PULSE AT 500:

![image](https://github.com/kavyasenthamarai/EXPERIMENT--07-SQUARE-WAVE-GENERATION-AT-THE-OUTPUT-PIN-USING-TIMER/assets/118668727/13016990-de2d-405a-a54c-1f6de8200e3b)
```
TON = 8 
TOFF = 8
TOTAL TIME = 16
...
![image](https://github.com/kavyasenthamarai/EXPERIMENT--07-SQUARE-WAVE-GENERATION-AT-THE-OUTPUT-PIN-USING-TIMER/assets/118668727/f8387a29-6db6-45eb-931e-c92652e9cbed)
```
TON = 13
TOFF= 3
TOTAL TIME = 16
...
![image](https://github.com/kavyasenthamarai/EXPERIMENT--07-SQUARE-WAVE-GENERATION-AT-THE-OUTPUT-PIN-USING-TIMER/assets/118668727/a5f72d56-116b-409a-a15f-d21ee15e5e15)
```
TON = 14
TOFF= 2
TOTAL TIME = 16
